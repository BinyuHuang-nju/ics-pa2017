...
/* 0x8c - 0x8f*/	inv, lea_m2r_v, mov_rm2sr_v, inv,
...
/* 0xcc - 0xcf*/	inv, int_imm, inv, iret,
...
/* 0xe0 - 0xe3*/	loopne_b, inv, inv, inv,
/* 0xe4 - 0xe7*/	inv, inv, inv, inv,
/* 0xe8 - 0xeb*/	call_i_v, jmp_near, ljmp, jmp_short,
...
{inc_rm_v, dec_rm_v, call_rm_v, call_rm_v, jmp_rm_v, jmp_rm_v, push_rm_v, inv};

instr_func group_7_entry[8] = 
{inv, inv, lgdt_imm, lidt, inv, inv, inv, inv};
